# Ethers-Ganache Simple Storage

![alt text](https://trufflesuite.com/img/ganache-header.svg)

## About The Project

This project is the basic illustration of Solidity contract deployed on local host(Ganache) and testnet(Alchemy-Rinkeby.
It provides basic instructions on how to install required dependencies and get familiar with tools and techniques in block chain development.
...
-   [Alchemy](https://www.alchemy.com/)
    -   Alchemy dashboard:
        <br>
        <img src = "./img/alchemy.png" alt = "alchemy" width = "200"/>

### Optional Gitpod

If you can't or don't want to run and install locally, you can work with this repo in Gitpod. If you do this, you can skip the `clone this repo` part.

[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#github.com/vaasanthk/Etheres-Ganache-Simple-Storage)
...
```
git clone https://github.com/vaasanthk/Etheres-Ganache-Simple-Storage
